...
assert(tests>=102&&failures===0,'All rule, save, village and delivery tests must pass.');
...
if(process.argv.includes('--publish')){
 ...
 for(const name of ['mobile-home.png','mobile-memory.png','mobile-village.png','mobile-routes.png','mobile-trail-journal.png'])fs.copyFileSync(path.join(OUT,'browser/chromium',name),path.join('docs/screenshots',name));
}
console.log(report);
