...
検証日時：2026-09-11T11:33:38.376Z
入力コミット：8b868d6bdbd179014dc6695946ffe3198e680e30

## 実行結果
- Node.jsのルール・保存・配信テスト：84件、失敗0件。
- ブラウザ：chromium 18項目、webkit 17項目を完了。
- 混合操作テスト：4つの固定シード、合計1,200操作の後もセーブの整合性を検査。
- 初回に必要なゲーム本体・画像など：合計171,572バイト（未圧縮）。外部JavaScript CDNは不要。
