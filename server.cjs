...
const ASSETS = Object.freeze(['index.html', 'style.css', 'app.js', 'game.js', 'journey.js', 'art.js', 'persistence.js', 'offline.js', 'sw.js', 'manifest.webmanifest', 'favicon.svg', 'assets/forest.svg', 'assets/icon-192.png', 'assets/icon-512.png']);
