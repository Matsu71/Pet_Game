...
function worker(scope){
 ...
 const keys=[prefix+'old-release',prefix+'20260911-trails-1','forest-you-'+encodeURIComponent('/Another_Game/')+'-old','unrelated-cache'];
...
test('runtime code and local art remain within a 300 KB uncompressed budget',()=>{
 const files=['index.html','game.js','world.js','journey.js','village.js','village-ui.js','village.css','persistence.js','art.js','app.js','style.css','offline.js','sw.js','manifest.webmanifest','favicon.svg','assets/forest.svg','assets/icon-192.png','assets/icon-512.png'];
